...
export interface MonthlySubscriptionPlan extends BaseContract {
  constructor(jsonInterface: any[], address?: string, options?: ContractOptions): MonthlySubscriptionPlan;
  clone(): MonthlySubscriptionPlan;
  methods: {
    /**
    ...
    monthlyRate(): NonPayableTransactionObject<string>;
    ...
    tier(): NonPayableTransactionObject<string>;
    ...
    extendSubscription(vcid: number | string, amount: number | string): NonPayableTransactionObject<void>;
  };
  events: {
