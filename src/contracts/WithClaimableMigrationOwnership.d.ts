...
export interface WithClaimableMigrationOwnership extends BaseContract {
  constructor(jsonInterface: any[], address?: string, options?: ContractOptions): WithClaimableMigrationOwnership;
  clone(): WithClaimableMigrationOwnership;
  methods: {
    /**
