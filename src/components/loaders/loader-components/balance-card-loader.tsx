...
const BalanceCardLoader = ({ style }: IBaseLoader) => {
  ...
  return (
    <StyledGrid container direction={'column'}>
      ...
      <CommonDivider />
      <LoaderFigure className={classes.balanceCardbottomFigure}></LoaderFigure>
      <LoaderFigure className={classes.balanceCardlastFigure}></LoaderFigure>
    </StyledGrid>
  );
};
